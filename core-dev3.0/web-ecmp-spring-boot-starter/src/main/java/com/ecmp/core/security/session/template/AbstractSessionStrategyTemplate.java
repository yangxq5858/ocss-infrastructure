package com.ecmp.core.security.session.template;
 ...
 * session处理策略，模板方法
 *
 * @author Vision.Mac 2018-06-06 13:38
 */
public class AbstractSessionStrategyTemplate {
    ...
    protected void onSessionInvalid(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (StringUtils.isNotBlank(securityProperties.getSession().getSessionInvalidUrl())) {
            ...
            response.getWriter().write(JsonUtils.toJson(new OperateStatus(false, message).data(null)));
        }
    }
